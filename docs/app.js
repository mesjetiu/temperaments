const APP_VERSION = 'e1d4320 · 2026-04-12';
...
const PitchADlg = {
  ...
  onContinuousChange() {
    ...
    if (!chk) return;
    _prefs.ruuviContinuous = chk.checked;
    savePrefs({ ruuviContinuous: chk.checked });
    ruuviApplyStreamingClass();
    // Instalar o retirar callback del sensor
    if (typeof RuuviScanner !== 'undefined') {
      RuuviScanner.onTemperature = chk.checked && RuuviScanner.streaming ? ruuviOnTemperature : null;
    }
  },
